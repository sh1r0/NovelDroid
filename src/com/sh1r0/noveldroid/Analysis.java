...
public class Analysis {
	private static final String[] ANALYZER_CLASS_NAME = {
			Ck101Analyzer.class.getName(), EynyAnalyzer.class.getName() };
	...
	public static NovelInfo analysisUrl(int domainID, String tid) throws Exception {
		...
		AsyncTask<NovelInfo, Integer, NovelInfo> request = (AsyncTask<NovelInfo, Integer, NovelInfo>) Class.forName(
				ANALYZER_CLASS_NAME[domainID]).newInstance();
